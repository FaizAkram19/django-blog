...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        """
        Questions with published date in the past that
        can be displayed on the index page.
        """
    ...
    def test_future_and_past_question(self):
        """
        When both future and past questions exist only
        display the past questions
        """
        question=create_question(question_text="Past question",days=-30)
    ...
    def test_two_past_questions(self):
        """
        The question page may display multiple questions.
        """
